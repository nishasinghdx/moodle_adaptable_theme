...
<?php echo $OUTPUT->standard_head_html() ?>
    ...
    <link href="theme/adaptable/style/css/bootstrap.min.css" rel='stylesheet' type='text/css' />
       <link href="theme/adaptable/style/css/bootstrap.css" rel='stylesheet' type='text/css' />
       <script type="application/x-javascript"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false); function hideURLbar(){ window.scrollTo(0,1); } </script>
       <link href="theme/adaptable/style/css/style.css" rel="stylesheet" type="text/css" media="all" />
       	<link rel="stylesheet" href="theme/adapatable/style/fonts/css/font-awesome.min.css">
       <script type="text/javascript" src="theme/adaptable/style/js/jquery.min.js"></script>
       <script type="text/javascript" src="theme/adaptable/style/js/bootstrap.js"></script>
       <script type="text/javascript" src="theme/adaptable/style/js/bootstrap.min.js"></script>
       <script type="text/javascript" src="theme/adaptable/style/js/modernizr.custom.28468.js"></script>
       <script type="text/javascript" src="theme/adaptable/style/js/jquery.cslider.js"></script>
...
<div class="container">
    <nav class="navbar navbar-default navbar-left" role="navigation" style="width:100%;">
